export default function Footer() {
  ...
  return (
    // Added a subtle cyan shadow to the top border
    <footer className="border-t border-white/5 py-12 px-4 shadow-[0_-4px_30px_rgba(6,182,212,0.03)] relative">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-6">
            <a href="https://www.linkedin.com/in/naveen-sharma-a34365293" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors hover:scale-110 duration-300">
            ...
            <a href="https://github.com/naveencoding75/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors hover:scale-110 duration-300">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
